...
def item(item_id):
    ...
    if item:
        ...
        return render_template("item.html", item=item, deleteItemForm=deleteItemForm, updateItemForm=updateItemForm)
...
def edit_item(item_id):
    ...
    if item:
        ...
        if form.validate_on_submit():
            ...
            conn.commit()
            flash("Item{} has been successfuly updated".format(form.title.data), "success")
        ...
        render_template("edit_item.html", item=item, form=form)
...
def home():
    ...
    ## CODE WORKS BUT ITS NOT VALIDATING FOR SOME REASON AND KEEPS HITTING THE ELSE STATEMENT INSTEAD
    if form.validate():
    ...
    ## GET ITEMS FROM DATABASE AND STORE IN TUPLES
    

    ##CREATE ITEM DICTIONARY FOR EACH ITEM
    items = []
